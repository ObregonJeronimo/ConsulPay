  ...
  return (
    <div className="cp-modal-overlay" {...overlayProps}>
      <div className="cp-modal cp-modal--wide" onClick={(e) => e.stopPropagation()}>
        ...
        {done ? (
          <div className="cp-modal__form" style={{ textAlign: 'center', padding: '32px 0' }}>
            <div style={{ marginBottom: 14 }}>
              <svg viewBox="0 0 24 24" width="48" height="48" fill="none" stroke="var(--cp-accent)" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div style={{ color: 'var(--cp-text-muted)', fontSize: 13.5, marginBottom: 24 }}>
              El administrador revisará la solicitud y creará el paciente.
            </div>
            <Button variant="primary" onClick={onClose} style={{ minWidth: 120, maxWidth: 180 }}>Cerrar</Button>
          </div>
        ) : (
